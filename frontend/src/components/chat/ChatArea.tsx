...
export const ChatArea = () => {
  ...
  const hasAdminDocuments = adminDocuments.some(
  ...
  const hasProcessingPdf =
    pdfs.length > 0 && pdfs.some((pdf) => pdf.status === "processing");
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <Button
              ...
              className="bg-blue-50 text-blue-700 border-blue-200 hover:bg-blue-100 hover:text-blue-800 hover:border-blue-300 transition-all duration-200 px-4 py-2"
            >
              ...
              {isAdmin ? (
                <>
                  ...
                  <p className="text-muted-foreground mb-4">
                    Upload PDFs and ask questions about your documents. I'll
                    provide answers based on the content.
                  </p>
                  <div className="space-y-2 text-sm text-muted-foreground">
                    <p>
                      • Upload research papers, reports, or any PDF documents
                    </p>
                  ...
                  {hasProcessingPdf && (
                    <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-lg text-amber-800 text-sm">
                      ...
                      Your PDF is still processing. You can start chatting, but
                      responses will use general AI until processing completes.
                    </div>
                  )}
                </>
              ) : hasAdminDocuments ? (
                <>
                  ...
                  <p className="text-muted-foreground mb-4">
                    Ask questions about the available documents in the knowledge
                    base.
                  </p>
                  <div className="space-y-2 text-sm text-muted-foreground">
                ...
                <>
                  ...
                  <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg text-blue-800 text-sm">
                    ...
                    Please wait for an administrator to upload documents to the
                    knowledge base before you can start chatting.
                  </div>
                </>
              )}
            </motion.div>
